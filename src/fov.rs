...
use crate::maps::{TilePosition, RegionMap};
...
impl FieldOfView {
    pub fn new(range: i32) -> Self {
        Self { range, fov_set: HashSet::new() }
    }
}

pub fn update_field_of_view(
    mut fov_query: Query<(&mut FieldOfView, &TilePosition), Or<(Changed<TilePosition>, Added<TilePosition>)>>,
    map: Res<RegionMap>
) {
